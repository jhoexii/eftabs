...
#!/bin/bash
wget -O /usr/local/sbin/jho/active.sh http://107.152.37.78/eftabs/app/prem
wget -O /usr/local/sbin/jho/inactive.sh http://107.152.37.78/eftabs/app/xprem
wget -O /usr/local/sbin/jho/deleted.sh http://107.152.37.78/eftabs/app/deleted
